# Generated by Django 2.2.16 on 2022-07-28 14:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'User'), ('moderator', 'Moderator')], default='user', max_length=100, verbose_name='Роль')),
        ...
        migrations.AddConstraint(
            model_name='follow',
            constraint=models.CheckConstraint(check=models.Q(_negated=True, user=django.db.models.expressions.F('following')), name='not_sub'),
        ),
    ]
